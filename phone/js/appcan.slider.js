    ...
    SliderView.prototype = {
        ...
        set:function(data){
            ...
            if(self.option.hasCircle){
                ...
                var zamcon = $('<div class="labelcon1" name="labContent" style="margin-right : .5em;float: left;padding: 0.25em;background-color: #A9C500;border-radius: 50%;"></div>');
                ...
                dian[0].style.cssText='margin-top:0.75em;margin-left:85%;';
            ...
            self.ele.off("swipeLeft").on("swipeLeft",function(evt){
                    ...
                    for(var i = 0;i < name.length;i++){
                        if(i == index){
                            name[i].style.cssText= 'margin-right : .5em;float: left;padding: 0.25em;background-color: #A9C500;border-radius: 50%;';
                        }else{
